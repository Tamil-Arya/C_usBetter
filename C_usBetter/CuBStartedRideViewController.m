...
- (IBAction)selectUser:(id)sender {
    ...
    [[NetworkHandler sharedInstance] sendRideRequest:@{@"StartRiderUserId":[NetworkHandler sharedInstance].loginUserID,@"PickupRiderUserId":@"4",@"RequestStatus":@1} withURL:@"details/SendRideRequest" withMethod:@"POST" completionHandler:^(NSDictionary *response, NSError *error) {
